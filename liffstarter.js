...
function getP() {
  ...
  if (!tipe) {
    document.getElementById('profilex').addEventListener('click', function() {
      liff.sendMessages([{
        type: 'template',
        altText: 'D-RAINS BOTS Corp..',
        template: {
          type: 'buttons',
          thumbnailImageUrl: 'https://i.ibb.co/T8Hffn6/Rains.png',
          imageAspectRatio: 'square',
          imageSize: 'cover',
          title: 'D-RAINS BOTS Corp..',
          text: 'LINE Future ゲン',
          actions: [
            {
              type: 'uri',
              label: 'Official',
              uri: 'https://lin.ee/zkSUtlj'
            }
          ]
        }
      }]).then(function() {
    ...
    document.getElementById('textx').addEventListener('click', function() {
      liff.sendMessages([{
        ...
        sentBy: {
          ...
          iconUrl: 'https://i.ibb.co/XbnwBGV/birdd.png',
          linkUrl: 'https://line.me/ti/p/~itsme.rains'
        }
      }]).then(function() {
        liff.closeWindow();
      });
    ...
    document.getElementById('imagex').addEventListener('click', function() {
      liff.sendMessages([{
        type: 'image',
        originalContentUrl: 'https://i.ibb.co/T8Hffn6/Rains.png',
        previewImageUrl: 'https://i.ibb.co/T8Hffn6/Rains.png',
        sentBy: {
          label: 'D-RAINS BOTS Corp..',
          iconUrl: 'https://i.ibb.co/XbnwBGV/birdd.png',
          linkUrl: 'https://line.me/ti/p/~itsme.rains'
...
function makeProfile() {
  ...
  liff.getProfile().then(function(prof) {
    ...
    if (pict == null) {
      var pict = 'https://i.ibb.co/559fzsc/noImage.jpgg';
    }
